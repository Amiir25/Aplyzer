  ...
  return (
    ...
    <div className='px-6 md:px-12 lg:px-24 xl:px-32 mt-10 my-20'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
            ...
            {/* Total */}
            <div className='relative h-64 w-fit px-4 py-2 shadow-xl border-t-6 border-[#02EBEB]'>
                ...
                <p className='absolute bottom-4 left-4 mt-2 text-xl font-black bg-[#02EBEB]/20 w-fit px-2
                    text-[#02EBEB]'>1
                    2
                </p>
            </div>
            ...
            {/* Interviwed */}
            <div className='relative h-64 w-fit px-4 py-2 shadow-xl border-t-6 border-[#5FEB02]'>
                ...
                <p className='absolute bottom-4 left-4 mt-2 text-xl font-black bg-[#5FEB02]/20 w-fit px-2
                    text-[#5FEB02]'>
                    3
                </p>
            </div>
            ...
            {/* Rejected */}
            <div className='relative h-64 w-fit px-4 py-2 shadow-xl border-t-6 border-[#EB0202]'>
                ...
                <p className='absolute bottom-4 left-4 mt-2 text-xl font-black bg-[#EB0202]/20 w-fit px-2
                    text-[#EB0202]'>
                    4
                </p>
            </div>
            ...
            {/* Pending */}
            <div className='relative h-64 w-fit px-4 py-2 shadow-xl border-t-6 border-[#EBE702]'>
                ...
                <p className='absolute bottom-4 left-4 mt-2 text-xl font-black bg-[#EBE702]/20 w-fit px-2
                    text-[#EBE702]'>
                    5
                </p>
            </div>
