...
const Hero = () => {
  return (
    ...
    <div className='h-80vh md:h-screen flex flex-col items-center px-2 md:px-16 lg:px-24 xl:px-32 pt-40 md:pt-30 text-center'>
        ...
        <p className='sm:text-2xl md:text-3xl text-gray-800 my-4 px-2 lg:px-10 xl:px-30'>
        ...
        {/* Hero button */}
        <Link to={'/auth/signup'}>
          <button className='my-10 text-xl sm:text-2xl font-medium px-4 py-2 md:px-6 md:py-4 rounded text-white
          bg-gradient-to-r from-blue-900 to-blue-500 hover:opacity-90 cursor-pointer active:opacity-100'>
            Start Tracking Jobs
          </button>
        </Link>

        <button className='text-2xl sm:text-3xl font-medium px-4 md:py-4 text-blue-600'>
